...
data class GameStrings(
    ...
    val howToPlayPage1Title: String,
    val howToPlayPage1Body: String,
    val howToPlayPage2Title: String,
    val howToPlayPage2Body: String,
    val howToPlayGotIt: String,
    val getReady: String,
    ...
    companion object {
        ...
        private val Russian = GameStrings(
            ...
            categoriesHint = "Простые — зелёные, средние — оранжевые, сложные — красные. Темы без уровня — во вкладке «Ещё»",
            start = "Старт",
            selectCategories = "Выберите категории",
            selectAllOnTab = "Выбрать все",
            clearTab = "Сбросить",
            language = "Язык",
            ...
            howToPlayPage1Title = "Объясните слово",
            howToPlayPage1Body = "Команда угадывает, а вы объясняете — голосом, жестами, ассоциациями. Нельзя называть само слово и однокоренные.",
            howToPlayPage2Title = "Зелёная — очко, красная — пропуск",
            howToPlayPage2Body = "Если угадали — зелёная кнопка, команда получает очко. Если слово не идёт — красная, очка нет, берёте следующее.",
            howToPlayGotIt = "Понятно",
            ...
            winner = "Победитель",
            catchUpHint = "Ещё раунд, чтобы все сыграли",
        ...
        private val English = GameStrings(
            ...
            categoriesHint = "Easy is green, medium orange, hard red. Packs without a level are under More",
            start = "Start",
            selectCategories = "Select categories",
            selectAllOnTab = "Select all",
            clearTab = "Clear",
            language = "Language",
            languageRussian = "Русский",
            languageEnglish = "English",
            ...
            howToPlayPage1Title = "Explain the word",
            howToPlayPage1Body = "Your team guesses while you explain — talk, gesture, use associations. Don't say the word itself or share the same root.",
            howToPlayPage2Title = "Green scores, red skips",
            howToPlayPage2Body = "If they guess it, tap green for a point. If you want to pass, tap red — no point, next word.",
            ...
            winner = "Winner",
            catchUpHint = "Another round so every team can play",
